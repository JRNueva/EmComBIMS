...
function UpdatePasswordDialog({ onCancel, onConfirm }) {
  ...
  return (
    ...
    >
      <div className="bg-white p-5 shadow-lg w-[400px] max-w-[90%]">
        ...
        <div className="mt-5">
                <div>
                    <h4 className="m-0 text-[16px]">Old Password</h4>
                </div>
          <input
            type="password"
          ...
          />
          <div>
                    <h4 className="m-0 text-[16px]">New Password</h4>
            </div>
          <input
            type="password"
